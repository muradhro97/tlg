...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.labors_departments'),'url'=>'labors-department'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.labors_departments') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
            ...
            @can('addLaborDepartment')
                <div class="">
                    <a href="{{url('admin/labors-department/create')}}" class="btn btn-primary">
            ...
            @if($rows->count()>0)
                <div class="table-responsive">
                    <table class="data-table table table-bordered">
                        ...
                        @can('editLaborDepartment')
                            <th class="text-center">{{trans('main.edit') }}</th>
                        @endcan
                        @can('deleteLaborDepartment')
                            ...
                            <tr>
                                ...
                                @can('editLaborDepartment')
                                    <td class="text-center"><a
                                                href="{{url('admin/labors-department/'.$row->id.'/edit')}}"
                                                class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteLaborDepartment')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/labors-department/'.$row->id) )) }}
