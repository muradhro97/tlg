...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.universities'),'url'=>'university'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content">
            @can('addUniversity')
            <div class="">
                <a href="{{url('admin/university/create')}}" class="btn btn-primary">
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                @can('editUniversity')
                                    <td class="text-center"><a href="{{url('admin/university/'.$row->id.'/edit')}}"
                                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteUniversity')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/university/'.$row->id) )) }}
