...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.states'),'url'=>'state'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content m-b-sm border-bottom">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    {!! Field::select('country_id' , trans('main.country'),$countries, trans('main.country'),'select2',request()->country_id) !!}
                </div>
