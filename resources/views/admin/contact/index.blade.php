...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.contacts'),'url'=>'contact'])
@stop
@section('content')
...
{{--                        @can('deleteExtractItem')--}}
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->address}}</td>
                                <td>{{$row->details ?? '---'}}</td>
                                <td class="text-center"><a href="{{url('admin/contact/'.$row->id.'/edit')}}"
                                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                </td>
                                {{--@endcan--}}
{{--                                @can('deleteExtractItem')--}}
                                <td class="text-center">
                                    {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/contact/'.$row->id) )) }}
