...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.projects'),'url'=>'project'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content">
            @can('addProject')
                <div class="">
                    <a href="{{url('admin/project/create')}}" class="btn btn-primary">
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                @can('editProject')
                                    <td class="text-center"><a href="{{url('admin/project/'.$row->id.'/edit')}}"
                                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteProject')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/project/'.$row->id) )) }}
