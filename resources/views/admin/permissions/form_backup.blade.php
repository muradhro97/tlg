            ...
            <div class="col-md-3">
                <div class="form-group custom-ul">
                    ...
                    <ul class="list-unstyled permission-ul">
                        ...
                        <li>
                            <input type="checkbox" id="managerNotificationWorkerLoan" name="per[]" value="managerNotificationWorkerLoan"
                                   @if(in_array('managerNotificationWorkerLoan',$permissions)) checked @endif
                            >
                            <label for="managerNotificationWorkerLoan">
                                {{trans('main.manager_notification')}}
                            </label>
                        </li>
                        <li>
                            <input type="checkbox" id="safeNotificationWorkerLoan" name="per[]"
                                   @if(in_array('safeNotificationWorkerLoan',$permissions)) checked @endif
                                   value="safeNotificationWorkerLoan">
                            <label for="safeNotificationWorkerLoan">
            ...
            <div class="col-md-3">
                <div class="form-group custom-ul">
                    ...
                    <ul class="list-unstyled permission-ul">
                        ...
                        <li>
                            <input type="checkbox" id="managerNotificationEmployeeLoan" name="per[]" value="managerNotificationEmployeeLoan"
                                   @if(in_array('managerNotificationEmployeeLoan',$permissions)) checked @endif
                            >
                            <label for="managerNotificationEmployeeLoan">
                                {{trans('main.manager_notification')}}
                            </label>
                        </li>
                        <li>
                            <input type="checkbox" id="safeNotificationEmployeeLoan" name="per[]"
                                   @if(in_array('safeNotificationEmployeeLoan',$permissions)) checked @endif
                                   value="safeNotificationEmployeeLoan">
                            <label for="safeNotificationEmployeeLoan">
                                {{trans('main.safe_notification')}}
                            </label>
                        </li>
                    </ul>
            ...
            <div class="col-md-3">
                <div class="form-group custom-ul">
                    ...
                    <ul class="list-unstyled permission-ul">
                        ...
                        <li>
                            <input type="checkbox" id="managerNotificationWorkerSalary" name="per[]" value="managerNotificationWorkerSalary"
                                   @if(in_array('managerNotificationWorkerSalary',$permissions)) checked @endif
                            >
                            <label for="managerNotificationWorkerSalary">
                                {{trans('main.manager_notification')}}
                            </label>
                        </li>
                        <li>
                            <input type="checkbox" id="safeNotificationWorkerSalary" name="per[]"
                                   @if(in_array('safeNotificationWorkerSalary',$permissions)) checked @endif
                                   value="safeNotificationWorkerSalary">
                            <label for="safeNotificationWorkerSalary">
                                {{trans('main.safe_notification')}}
                            </label>
                        </li>
                    </ul>
            ...
            <div class="col-md-3">
                <div class="form-group custom-ul">
                    ...
                    <ul class="list-unstyled permission-ul">
                        ...
                        <li>
                            <input type="checkbox" id="managerNotificationEmployeeSalary" name="per[]" value="managerNotificationEmployeeSalary"
                                   @if(in_array('managerNotificationEmployeeSalary',$permissions)) checked @endif
                            >
                            <label for="managerNotificationEmployeeSalary">
                                {{trans('main.manager_notification')}}
                            </label>
                        </li>
                        <li>
                            <input type="checkbox" id="safeNotificationEmployeeSalary" name="per[]"
                                   @if(in_array('safeNotificationEmployeeSalary',$permissions)) checked @endif
                                   value="safeNotificationEmployeeSalary">
                            <label for="safeNotificationEmployeeSalary">
                                {{trans('main.safe_notification')}}
                            </label>
                        </li>
                    </ul>
            ...
            <div class="col-md-3">
                <div class="form-group custom-ul">
                    ...
                    <ul class="list-unstyled permission-ul">
                        ...
                        <li>
                            <input type="checkbox" id="managerNotificationInvoice" name="per[]" value="managerNotificationInvoice"
                                   @if(in_array('managerNotificationInvoice',$permissions)) checked @endif
                            >
                            <label for="managerNotificationInvoice">
                                {{trans('main.manager_notification')}}
                            </label>
                        </li>
                        <li>
                            <input type="checkbox" id="safeNotificationInvoice" name="per[]"
                                   @if(in_array('safeNotificationInvoice',$permissions)) checked @endif
                                   value="safeNotificationInvoice">
                            <label for="safeNotificationInvoice">
                                {{trans('main.safe_notification')}}
                            </label>
                        </li>
                        <li>
                            <input type="checkbox" id="stockNotificationInvoice" name="per[]"
                                   @if(in_array('stockNotificationInvoice',$permissions)) checked @endif
                                   value="stockNotificationInvoice">
                            <label for="stockNotificationInvoice">
            ...
            <div class="col-md-3">
                <div class="form-group custom-ul">
                    ...
                    <ul class="list-unstyled permission-ul">
                        ...
                        <li>
                            <input type="checkbox" id="safeNotificationAccountingCashIn" name="per[]"
                                   @if(in_array('safeNotificationAccountingCashIn',$permissions)) checked @endif
                                   value="safeNotificationAccountingCashIn">
                            <label for="safeNotificationAccountingCashIn">
                                {{trans('main.safe_notification')}}
                            </label>
                        </li>
                    </ul>
