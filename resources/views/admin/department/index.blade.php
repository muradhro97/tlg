...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.departments'),'url'=>'department'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content">
            @can('addDepartment')
            <div class="">
                <a href="{{url('admin/department/create')}}" class="btn btn-primary">
                    ...
                    <table class="data-table table table-bordered" >
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                @can('editDepartment')
                                <td class="text-center"><a href="{{url('admin/department/'.$row->id.'/edit')}}"
                                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                </td>
                                @endcan
                                @can('deleteDepartment')
                                <td class="text-center">
                                    {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/department/'.$row->id) )) }}
