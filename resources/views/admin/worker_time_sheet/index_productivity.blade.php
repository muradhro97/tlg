        ...
        <div class="ibox-content">
            ...
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li class=""><a href="{{url('admin/worker-time-sheet')}}"> {{trans('main.daily')}}</a></li>
                    {{--<li class=""><a href="{{url('admin/invoice/create')}}">Expenses</a></li>--}}
                    <li class="active"><a href="#">{{trans('main.productivity')}}</a></li>
                </ul>
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            ...
                            @if($rows->count()>0)
                                {!! Form::model($model,[
                                                'action'=>'Admin\WorkerTimeSheetController@storeProductivity',
                                                'id'=>'myForm',
                                                'role'=>'form',
                                                   'files'=>'true',
                                                'method'=>'POST'
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="control-label"
                                                   for="productivity">{{trans('main.productivity')}}</label>
                                            {{Form::text('productivity', null, [
                                        "placeholder" => trans('main.number'),
