...
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content">
            <div class="">
                <a href="{{url('admin/stock-type/create')}}" class="btn btn-primary">
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="{{url('admin/stock-type/'.$row->id.'/edit')}}"
                                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                </td>
                                <td class="text-center">
                                    {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/stock-type/'.$row->id) )) }}
