...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.cities'),'url'=>'city'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content m-b-sm border-bottom">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    {!! Field::select('state_id' , trans('main.state'),$states, trans('main.state'),'select2',request()->state_id) !!}
                </div>
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                @can('editCity')
                                    <td class="text-center"><a href="{{url('admin/city/'.$row->id.'/edit')}}"
                                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteCity')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/city/'.$row->id) )) }}
