...
@section('content')
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.sub_contracts') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
            @can('addSubContract')
                <div class="">
                    <a href="{{url('admin/sub-contract/create')}}" class="btn btn-primary">
            ...
            @if($rows->count()>0)
                <div class="table-responsive">
                    <table class="footable table table-bordered toggle-arrow-tiny print_table " data-sort="false">
                        ...
                        <th data-hide="all">{{trans('main.type') }}</th>
                        <th data-hide="all">{{trans('main.status') }}</th>
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a style="margin: 2px;" type="button" href="{{url('admin/sub-contract/'.$row->id)}}"
                                       class="btn btn-xs btn-primary"><i
                                                class="fa fa-eye"></i></a>
                                </td>

                                @can('editSubContract')
                                    <td class="text-center"><a href="{{url('admin/sub-contract/'.$row->id.'/edit')}}"
                                ...
                                @can('deleteSubContract')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/sub-contract/'.$row->id) )) }}
