...
<div class="ibox">
    <div class="ibox-title">
        <h5>{{trans('main.sub_contracts')}} |  {{trans('main.edit')}} </h5>
    ...
    <!-- form start -->
    {!! Form::model($model,[
                            'action'=>['Admin\SubContractController@update',$model->id],
                            'id'=>'myForm',
                            'role'=>'form',
                            'method'=>'PUT'
                            ])!!}
    <div class="ibox-content">
        @include('admin.sub_contract.form_edit')
    </div>
    ...
    {!! Form::close()!!}
        ...
        @include('admin.sub_contract.modal')
        @include('admin.sub_contract.script_edit')
@stop