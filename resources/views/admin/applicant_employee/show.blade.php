...
@section('content')
        ...
        <div class="ibox-content m-b-sm border-bottom float-e-margins">
            ...
            <div class="row">
                ...
                @if($row->evaluation_status== "accept")
                    <form method="post" action="{{route('approveEmployeeApplicant')}}" style="display: inline;">
                        {{csrf_field()}}
                        ...
                        <a class="btn btn-success " target="_blank" href="{{url('admin/print-letter/'.$row->id)}}"><i
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="m-b-md">
                                    ...
                                    @can('editEmpApp')
                                        <a href="{{url('admin/applicant-employee/'.$row->id.'/edit')}}"
    ...
    @include('admin.applicant_employee.show_modal')
@stop
@push('style')
