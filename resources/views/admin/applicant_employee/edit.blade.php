...
<div class="ibox">
    <div class="ibox-title">
        <h5>{{trans('main.applicant_employees')}} |  {{trans('main.edit')}} </h5>
    ...
    <!-- form start -->
    {!! Form::model($model,[
                            'action'=>['Admin\ApplicantEmployeeController@update',$model->id],
                            'id'=>'myForm',
                            'role'=>'form',
                             'files'=>'true',
                            'method'=>'PUT'
    ...
    <div class="ibox-content">
        @include('admin.applicant_employee.form_edit')
        @include('admin.applicant_employee.script_edit')
    </div>
