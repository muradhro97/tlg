...
//                console.log(value);
        ...
        $(function () {
            let educationsJs = {!! $educationsJs !!};
            let experiencesJs = {!! $experiencesJs !!};

            $.each(educationsJs, function (index, value) {


                let qualification_title = value.qualification_title;
                let university = value.university;
                let graduation_year = value.graduation_year;
...
//            console.log(total);
         ...
         <tr class="education-content-row" educationid="${educationCounter}" >
            ...
            $.each(experiencesJs, function (index, value) {
                let employer_name =value.employer_name;
                let from = value.from;
                let to = value.to;
                let position = value.position;
                let working_status = value.working_status;
