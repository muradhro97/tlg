...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.sizes'),'url'=>'size'])
@stop
@section('content')
...
{{--    </div>--}}
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content">
            ...
            <div class="">
                <a href="{{url('admin/size/create')}}" class="btn btn-primary">
...
{{--                        @can('deleteExtractItem')--}}
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                <td>{{$iteration}}</td>
                                <td>{{$row->size ?? '---'}}</td>
                                <td class="text-center"><a href="{{url('admin/size/'.$row->id.'/edit')}}"
                                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                </td>
                                {{--@endcan--}}
{{--                                @can('deleteExtractItem')--}}
                                <td class="text-center">
                                    {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/size/'.$row->id) )) }}
