...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.bank_accounts'),'url'=>'bank-account'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.bank_accounts') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
            @can('addBankAccount')
                <div class="">
                    <a href="{{url('admin/bank-account/create')}}" class="btn btn-primary">
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->balance}}</td>
                                @can('editBankAccount')
                                    <td class="text-center"><a href="{{url('admin/bank-account/'.$row->id.'/edit')}}"
                                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteBankAccount')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/bank-account/'.$row->id) )) }}
