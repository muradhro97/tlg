...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.stock_in'),'url'=>'stock-order'])
@stop
@section('content')
...
<div class="ibox ">
    ...
    <!-- form start -->
    {!! Form::model($model,[
                            'action'=>'Admin\StockOrderController@storeStockIn',
                            'id'=>'myForm',
                            'role'=>'form',
                            'method'=>'POST'
                            ])!!}
    <div class="ibox-content">
        ...
        @include('admin.stock_orders.stock_in_form')
    </div>
    ...
    @include('admin.stock_orders.script')
</div>
@stop