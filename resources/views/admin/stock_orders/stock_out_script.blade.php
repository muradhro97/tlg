@push('script')
    ...
    <script>
        ...
        $(document).on('click', '#add-item', function (e) {
            ...
            let is_manual_price = $("input[name='is_manual_price']").is(":checked");
...
//            $("input[name='buy_date']").val(today2);
            ...
            $("input[name='is_manual_price']").attr('checked', false); // Unchecks it
//            let index = items.findIndex(x => x.item_id === item_id);
            ...
            item.size = size;
            item.price = price;
            item.is_manual_price = is_manual_price;
