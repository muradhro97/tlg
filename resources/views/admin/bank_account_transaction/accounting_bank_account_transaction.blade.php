...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.accounting_bank_account_transaction'),'url'=>'accounting-bank-account-transaction'])
@stop
@section('content')
    ...
    $safes = $safe->oldest()->where('id', '!=', 0)->pluck('name', 'id')->toArray();
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.accounting_bank_account_transaction') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
