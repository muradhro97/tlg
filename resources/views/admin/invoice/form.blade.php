...
<div class="tabs-container">
    <ul class="nav nav-tabs">
        @can('addInvoice')
            <li class="active"><a href="#"> {{trans('main.invoices')}}</a></li>
            {{--<li class=""><a href="{{url('admin/invoice/create')}}">Expenses</a></li>--}}
        @endcan
        @can('addExpense')
            <li class=""><a href="{{url('admin/create-expense')}}">{{trans('main.expenses')}}</a></li>
        @endcan
    </ul>
        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <div class=" row">
                    ...
                    <div class="col-xs-3" style="padding-right: 5px;">
                        {{Form::text('price', null, [  "placeholder" =>trans('main.price'), "class" => "form-control floatonly", ])}}
                        <span class="help-block text-danger"><strong></strong></span>
                    </div>
