...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.expense_items'),'url'=>'expense-item'])
@stop
@section('content')
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.expense_items') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
            @can('addExpenseItem')
                <div class="">
                    <a href="{{url('admin/expense-item/create')}}" class="btn btn-primary">
...
{{--                                <td>{{$row->nationality}}</td>--}}
                                @can('editExpenseItem')
                                    <td class="text-center"><a href="{{url('admin/expense-item/'.$row->id.'/edit')}}"
                                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteExpenseItem')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/expense-item/'.$row->id) )) }}
