...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.main_extracts'),'url'=>'main_extract'])
@stop
@section('content')
...
?>
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.main_extracts') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
            @can('addMainExtract')
            <div class="">
                <a href="{{url('admin/main_extract/create')}}" class="btn btn-primary">
...
{{--                                <td>{{$row->safe_transaction_id ?? ''}}</td>--}}
                                <td>{{$row->contract->contractType->name ?? ''}}</td>
                                ...
                                <td>
                                    ...
                                    @can('editMainExtract')
                                        <a href="{{route('main_extract.edit',$row->id)}}" class="btn btn-sm btn-success">
