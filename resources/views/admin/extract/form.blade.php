...
{{--    <div class="col-md-6" id="sub_contract_container">--}}
{{--        {!! Field::select('sub_contract_id' , trans('main.sub_contract'),$subContracts,trans('main.select_sub_contract')) !!}--}}
...
<div class=" row">
    <div class="col-xs-3" id="items_container" style="padding-right: 5px;">
        ...
        foreach ($parent->items as $detail)
        {
            $item = $detail->item;
            $new_items[$item->id]= $item->name  .' | '.$item->unit->name ?? '';
