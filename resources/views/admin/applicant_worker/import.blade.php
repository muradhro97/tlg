...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.applicant_workers'),'url'=>'applicant-worker-import'])
@stop
@section('content')
    <!-- FILE: app/views/start.blade.php -->
    <div class="ibox ">
        <div class="ibox-title">
            <h5>{{trans('main.applicant_workers')}} | {{trans('main.applicant_worker_import')}} </h5>
        ...
        <!-- form start -->
        {!! Form::model($model,[
                                'action'=>'Admin\ApplicantWorkerController@importSave',
                                'id'=>'myForm',
                                'role'=>'form',
                                'files'=>'true',
                                'method'=>'POST'
        ...
        <div class="ibox-content">
            ...
            <div class="form-group">
                ...
                <div class="">
                    <a class="btn btn-success" target="_blank" href="{{url('excel_sample.xlsx')}}"><i
