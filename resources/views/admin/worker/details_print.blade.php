...
<div class="invoice-box ">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <h1>{{trans('main.worker')}}  {{$row->name}} ({{$row->working_status_display}})</h1>
            ...
            <td >
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            {{trans('main.worker_classification') }}
                        </td>

                        <td>
                            {{$row->workerClassification->name ?? ''}}
                        </td>
                    </tr>
