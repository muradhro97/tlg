...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.banks'),'url'=>'bank'])
@stop
@section('content')
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                @can('editBank')
                                    <td class="text-center"><a href="{{url('admin/bank/'.$row->id.'/edit')}}"
                                                               class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                    </td>
                                @endcan
                                @can('deleteBank')
                                    <td class="text-center">
                                        {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/bank/'.$row->id) )) }}
