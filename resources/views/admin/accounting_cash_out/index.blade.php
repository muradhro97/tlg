...
@section('breadcrumb')
    ...
    @include('admin.layouts.partials.breadcrumb',['title'=>trans('main.accounting_cash_out'),'url'=>'accounting-cash-out'])
@stop
@section('content')
...
<div class="ibox ibox-primary">
    ...
    <div class="ibox ibox-primary">
        <div class="ibox-title">
            <h5>{{trans('main.accounting_cash_out') }}</h5>
            <div class="ibox-tools">
                <a class="collapse-link">
                    <i class="fa fa-chevron-up"></i>
                </a>
        ...
        <div class="ibox-content">
            ...
            @can('addAccountingCashOut')
                <div class="">
                    <a href="{{url('admin/accounting-cash-out/create')}}" class="btn btn-primary">
                                ...
                                @can('detailsAccountingCashOut')
                                    <td>
                                        <a style="margin: 2px;" type="button"
                                           href="{{url('admin/accounting-cash-out/'.$row->id)}}"
