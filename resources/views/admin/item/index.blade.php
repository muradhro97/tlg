...
@section('content')
    ...
    <div class="ibox ibox-primary">
        ...
        <div class="ibox-content">
            ...
            @can('addItem')
                <div class="">
                    <a href="{{url('admin/item/create')}}" class="btn btn-primary">
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                @can('editItem')
                                <td class="text-center"><a href="{{url('admin/item/'.$row->id.'/edit')}}"
                                                           class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
                                </td>
                                @endcan
                                @can('deleteItem')
                                <td class="text-center">
                                    {{Form::open(array('method'=>'delete','class'=>'delete','url'=>url('admin/item/'.$row->id) )) }}
